namespace RomanDate.Definitions
{
    ...
    public struct RomanSetDays
    {
        ...
        public static RomanSetDays Kalendae => new(SetDays.Kalendae, "Kalendas", "Kalendis", "Kal.");
        ...
        public static RomanSetDays Nonae => new(SetDays.Nonae, "Nonas", "Nonis", "Non.");
        ...
        public static RomanSetDays Idus => new(SetDays.Idus, "Idus", "Idibus", "Id.");
